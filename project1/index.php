...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // $imageData = addslashes($imageData);  // Get the temporary location of the uploaded file
    ...
    do {
        ...
        $stmt = $connection->prepare("INSERT INTO orders (username, pass, email, gender, platform, service, quantity, lang, screenshot) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssssiss", $username, $pass, $email, $gender, $platform, $service, $quantity, $lang, $imageData);
        ...
        if ($stmt->execute()) {
            ...
            $errorMessage = "Error inserting client data: " . $stmt->error; // Add error message
        }
...
<body>
    <div class="container my-5">
        <h3 class="text-success text-center">NEW ORDER</h3>
        <?php  
        ...
        <div class="form-container text-center">
            <form id="myForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                    <input type="radio" name="gender" id="male" value="male" <?php echo (empty($gender) || $gender === 'male') ? 'checked' : ''; ?>>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                    <input type="radio" name="lang" id="english" value="English" <?php echo (empty($lang) || $lang === 'English') ? 'checked' : ''; ?>>
                ...
                <br>
                    <button id="delete_btn" style="display: none;">Delete</button>
                <br>
                ...
                <div class= "row mb-3">
                    ...
                    <div class="col-sm-3 d-grid">
                        <a class="btn btn-outline-primary" href="/SCS_Task/project1/index.php" role="button">Cancel<a>
                    </div>
                </div>
            ...
            <a class="btn btn-primary" href="/SCS_Task/project1/order_history.php" role="button">View History</a>
        </div>
